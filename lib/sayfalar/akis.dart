...
import 'package:socialapp/widgetler/silinmeyenFutureBuilder.dart';
...
class _AkisState extends State<Akis> {
  ...
  _akisGonderileriniGetir() async {
    ...
    List<Gonderi> gonderiler =
        await FirestorServisi().akisGonderileriniGetir(aktifKullaniciId);
    if (mounted) {
      setState(() {
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return SilinmeyenFutureBuilder(
                future: FirestorServisi().kullaniciGetir(gonderi.yayinlayaId),
